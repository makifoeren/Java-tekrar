...
public class C01_LocalDate {
    ...
    public static void main(String[] args) {
        ...
        // dogumtarihimiz den ne kadar gecmis


        System.out.println(trh); // 2022-03-31
        // get'li method'larla tarih ile ilgili detay bilgileri alabiliriz (obj olusturuldugu tarih)
        ...
        System.out.println(LocalDate.now().isLeapYear()); // false artik yil
        System.out.println(trh.isAfter(baskaTrh)); // true   bugununtarihi benim dogumgünmden sonra
