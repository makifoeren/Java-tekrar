...
public class C04_TerstenSiralayipKaydetme {
    ...
    public static void main(String[] args) {
        ...
        arr = terstenSirala(arr); // burada esitleme yaptik
        System.out.println(Arrays.toString(arr)); // [45, 25, 9, 9, 6, 5, 4, 3, 1, 0] avabtji artik bu elimizde
        System.out.println("En buyuk Element : " + arr[0]);
    }
    public static int[] terstenSirala(int[] arr) {
        Arrays.sort(arr); // [0, 1, 3, 4, 5, 6, 9, 9, 25, 45] sirladik ayni uzunlukta olusturup döndürdük
